...
# --- CONTEXTUALLY ISOLATED PACKAGE IMPORT WRAPPERS ---
try:
...
st.markdown(f'<div class="dynamic-header"><h1>⚖️ Universal Enterprise {clean_domain_name} Analytics Suite</h1><p>Data-agnostic analytical pipeline running dynamic behavioral auditing against target metric: <b>{target_var}</b></p></div>', unsafe_allow_html=True)
